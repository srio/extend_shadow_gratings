...
class SurfaceConic(object):
    ...
    def apply_specular_reflection_on_beam(self,newbeam):
        ...
        x1 =   newbeam.getshcol([1,2,3]) # numpy.array(a3.getshcol([1,2,3]))
        v1 =   newbeam.getshcol([4,5,6]) # numpy.array(a3.getshcol([4,5,6]))
        flag = newbeam.getshonecol(10)        # numpy.array(a3.getshonecol(10))
    ...
    def apply_grating_vls_on_beam(self,newbeam, RULING = 3500.0, RUL_A1 = -3.1, RUL_A2 = 0.00215):
        # ;
        # ; TRACING...
        # ;

        #<<<<<<<<<<<<<<<<<<< TO BE MODIFIED, NOW IS COPIED FROM REFLECTION >>>>>>>>>>>>>>>>>>>>>>>>>
